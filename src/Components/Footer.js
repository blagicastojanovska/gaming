    ...
    <div className="container-fluid">
        ...
        <div className="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
          <div className="row">
            ...
            <div className="col-md-4 col-sm-4">
              <h2>За нас</h2>
              <p>
                Brainster е иновативна компанија за едукација и комбинира врвен наставен план,
      ...
      <div className="row footer-icon">
        <div className="col-md-12 text-right">
          ...
          >
            <img
              src={require("../assets/img/img-social-icons/instagram.png")}
              alt="Instagram-img"
            />
          </a>
          <a
          ...
          <a href="https://www.twitter.com/brainsterco" target="_blank" rel="noopener noreferrer">
